...
```css
--shadow: 0 2px 12px rgba(44, 36, 22, 0.1); /* Default card shadow */
...
```html
<link
  href="https://fonts.googleapis.com/css2?family=Lora:ital,wght@0,400;0,600;0,700;1,400&family=Nunito:wght@400;500;600;700&display=swap"
  rel="stylesheet"
/>
```
