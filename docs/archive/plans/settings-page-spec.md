> Historical note: This document is retained as implementation history. It may reference earlier route and component assumptions and should be used for background only.
