> Historical note: This document is retained as planning history. It may reference earlier package layout and migration assumptions and should not be treated as the current source of truth. See `docs/architecture.md`, `docs/developer-guide.md`, and `docs/release-guide.md` for the current Electron app.
