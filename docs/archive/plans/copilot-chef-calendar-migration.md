> Historical note: This document is retained as planning and implementation history. It may reference earlier architecture decisions and should not be treated as the current source of truth. See `docs/architecture.md`, `docs/developer-guide.md`, and `docs/release-guide.md` for the current Electron app.
