> Historical note: This document is retained as implementation history. It may reference earlier layout and migration assumptions and should not be treated as the current source of truth.
