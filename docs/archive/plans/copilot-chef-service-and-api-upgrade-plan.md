> Historical note: This document is retained as planning history. It predates parts of the current Electron app layout and release flow, so use it for context only. See `docs/architecture.md`, `docs/developer-guide.md`, and `docs/release-guide.md` for the current implementation.
