...
export function HomeDashboard() {
  ...
  return (
    <>
      ...
      <section className={cn(styles.quickLinks, styles.fadeIn)}>
        <Link className={styles.quickLink} to="/meal-plan">
          <span className={styles.quickLinkIcon}>📅</span>
          <span className={styles.quickLinkLabel}>Meal Plan</span>
        </Link>
        <Link className={styles.quickLink} to="/grocery-list">
          <span className={styles.quickLinkIcon}>🛒</span>
          <span className={styles.quickLinkLabel}>Grocery List</span>
        </Link>
        <Link className={styles.quickLink} to="/recipes">
          <span className={styles.quickLinkIcon}>📖</span>
          <span className={styles.quickLinkLabel}>Recipes</span>
        </Link>
        <Link className={styles.quickLink} to="/stats">
          <span className={styles.quickLinkIcon}>📊</span>
          <span className={styles.quickLinkLabel}>Stats</span>
        </Link>
      </section>
